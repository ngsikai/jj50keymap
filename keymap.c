...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      | Ctrl |      | Alt  | GUI  | Nav  |Space | GUI  | Alt  | Caps | Ctrl |      |
     * `-----------------------------------------------------------------------------------'
     */
    [_DEFLT] = LAYOUT( \
    ...
    [_NAV] = LAYOUT( \
       ...
       _______, _______, _______, _______, _______, _______, _______, LGUI(KC_LCBR), LGUI(KC_RCBR), _______, _______, _______, \
       _______, _______, _______, LGUI(KC_LCBR), LGUI(KC_RCBR), _______,  KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, _______, _______,  \
